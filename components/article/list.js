...
const List = ({ articles }) => {
    ...
    const addFavorite = (id) => {
        ...
        axios.put(`https://api.for9a.com/learn/favorite/${id}`, null,
            {
                headers:
    ...
    const deleteFavorite = (id) => {
        active[id] = 0
        setActive(active.slice());
        axios.delete(`https://api.for9a.com/learn/favorite/${id}`,
                    ...
                    <div className={`${darkMode ? css.dark : ''} ${css.list}`} key={index}>
                        <div className={css.image}>
                            ...
                            <div className={css.button}>
                                ...
                                <button id='btn' onClick={() => handleClick(item.titlte, item.url)} className={css.shareButton}> <svg xmlns="http://www.w3.org/2000/svg"
