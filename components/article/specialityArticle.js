                ...
                <div className={`all mt-3 md:w-3/4 md:flex md:relative`}>
                    ...
                    <div className={`container article text-base leading-8`}>
                        <div className={`breadcrumb flex -mb-2.5 mt-4`}>
                            <Link href={"/specialities"}><a className=' text-gray-500 no-underline text-sm ml-2.5 mb-0  hover:text-sky-600'>
                                 دليل التخصصات / 
                            </a></Link>
                            {thisArticle.categories.map((category, i) =>
                                <div className='flex' key={i}>
                                    <Link
                                        ...
                                        <a className='text-sm  mb-0 no-underline text-gray-500 ml-2  hover:text-sky-700'
                                            href={`${category.url.replace("https://www.for9a.com/", `${process.env.domain}/`)}`}
                                        >
                                           {category.title} 
                                        </a>
                        ...
                        {thisArticle.sections.map((section, i) =>
                            <div key={i}>
                                ...
                                <div className={css.content} dangerouslySetInnerHTML={{ __html: section.body }} />
                            </div>
